...
const Testimonial = () => {
  ...
  return (
    <>
      <div
        className="flex flex-col items-center my-8 scroll-mt-10"
        id="testimonials"
      >
        ...
        <Title
          ...
          description={
            "Join thousands of satisfied users who built standout resumes with the help of our AI-powered tools. See how they turned opportunities into success stories."
          }
        />
