  ...
  return (
    <div className="flex flex-col items-center my-8 scroll-mt-10" id="features">
      ...
      <Title
        ...
        description={
          "Create an impressive resume in minutes with AI-powered tools that generate tailored content, optimize design, and ensure your profile gets noticed by recruiters."
        }
      />
