import { ArrowRightToLine, Codesandbox } from "lucide-react";
  ...
  return (
    <>
      <style>{`
            ...
            `}</style>
      <section className="flex flex-col items-center justify-center mx-auto max-md:mx-2 max-md:px-2 max-w-5xl w-full text-center rounded-2xl py-16 my-10">
        <Codesandbox className="size-10 stroke-green-600" />
        ...
        <p className="text-sm text-gray-500 max-w-lg mt-2">
          Build a resume that opens doors. Our AI helps you highlight your
          strengths, design beautifully, and get noticed faster
        </p>
        <div className="flex gap-2">
          <button className="px-8 py-2.5 mt-4 text-sm bg-green-600 hover:scale-105 transition duration-300 text-white flex items-center gap-2">
